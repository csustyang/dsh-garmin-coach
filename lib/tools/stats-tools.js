...
export function defineStatsTools(ctx) {
    ...
    return [
        ...
        defineGarminTool({
            ...
            description: '统计指定时间窗口的总距离、次数、平均配速、最好配速。例如"本月跑量"。',
            parameters: {
        ...
        defineGarminTool({
            ...
            description: '统计最近 N 天的每日健康：平均步数、静息心率、睡眠、压力、HRV。',
            parameters: {
        ...
        defineGarminTool({
            ...
            description: '统计运动类型分布：每种运动的活动次数与总距离。用于了解训练结构。',
            parameters: {
                days: { type: 'integer', description: '统计最近多少天' },
            },
            execute: async (args) => {
        ...
        defineGarminTool({
            ...
            description: '查看训练计划的历史版本（备份）。每次保存/切换计划时旧版会备份到 history，' +
