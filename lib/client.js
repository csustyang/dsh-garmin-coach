...
window.__ModuleLoader__.load({
  ...
  factory: (require) => {
    ...
    function GarminSettingsSection() {
      ...
      var [fullSyncFrom, setFullSyncFrom] = useState('2022-01-01');
      ...
      var doSave = function () {
        ...
        api('save', { value: value, expectedRevision: rev })
          .then(function (snap) {
            setSnapshot(snap);
            // 如果账号变更（email 或 isCn 改了）→ 提示用户重新连接
            if (snap && snap.accountChanged) {
              setMessage('配置已保存 ✓ 账号已变更，请重新点击「重新连接（验证 token）」');
            } else {
              setMessage('配置已保存 ✓');
            }
                ...
                api('syncAllProgress', {})
                  .then(function (pb) {
                    ...
                    if (p.status === 'running') {
                      ...
                      setFullSyncMsg('✅ 全量同步完成：已处理 ' + p.processed + '/' + p.total + ' 个窗口');
        ...
        api('connect', {
          ...
          .then(function (body) {
            if (body && body.ok) {
              ...
              api('save', { value: Object.assign({}, draft, { status: 'connected', displayName: body.displayName || draft.displayName || '', lastSyncAt: snapshot && snapshot.lastSyncAt ? snapshot.lastSyncAt : '' }), expectedRevision: snapshot ? snapshot.revision : undefined })
                .then(function () { load(); })
          ...
          jsx('div', { className: 'garmin-settings-section', children: [
            ...
            jsx('div', { className: 'garmin-settings-actions', children: [
              jsx('button', {
                ...
                children: '立即同步（最近 ' + (draft.syncDaysBack || 90) + ' 天）',
              }),
            ] }),
    ...
    function GarminDashboard(props) {
      ...
      // Esc 关闭详情浮层
      useEffect(function () {
        var onKey = function (e) { if (e.key === 'Escape') setDetailOpenId(null); };
      ...
      return jsxs('div', { className: 'garmin-dash', children: [
        ...
        jsxs('div', { className: 'garmin-dash-section', children: [
          ...
          (function () {
            ...
            var colSpanTotal = colMeta.length + 1;
            ...
            jsx('div', {
              ...
              jsx('thead', { children: jsx('tr', { children: [
                ...
                jsx('th', { style: { width: '44px', textAlign: 'center' }, children: '✏️' }),
              ] }) }),
